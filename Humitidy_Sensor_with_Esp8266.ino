...
String agAdi = "network";                 // We write the name of our network here.    
String agSifresi = "network password";           // We write the password of our network here.
...
void loop() {
  ...
  String veri = "GET https://api.thingspeak.com/update?api_key=BRYI0S333XPUAZ4S";   // Thingspeak command. We write our own api key in the key part.                                   
  veri += "&field1=";
